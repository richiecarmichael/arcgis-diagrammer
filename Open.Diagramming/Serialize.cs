...
namespace Crainiate.Diagramming.Serialization
{
	public class Serialize
	{
		...
		public static Font GetFont(string delimitedString)
		{
			...
			return Component.Instance.GetFont(familyName,size,style);
		}
		...
		public static bool Contains(SerializationInfo info,string name)
		{
			try
			{
				object obj = info.GetValue(name,typeof(string));
				return true;
			}
			catch
			{
